                        ...
                        <div class="am-u-sm-12">
                            ...
                            <div class="am-form-group">
                                <div class="am-g">
                                    ...
                                    <input class="am-u-md-10 form-control" id="doc-ipt-text-1" name ="doc-ipt-text-1" placeholder="输入标题信息" ">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <div class="am-g">
                                    <label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-ipt-pwd-1">介绍</label>
                                    <input class="am-u-md-10 form-control" id="doc-ipt-text-2" name ="doc-ipt-text-2" placeholder="输入介绍信息" >
                                </div>
                            </div>
                            <div class="am-form-group">
                                <div class="am-g">
                                    <label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-ipt-pwd-1">报酬</label>
                                    <input class="am-u-md-10 form-control" id="doc-ipt-text-3" name ="doc-ipt-text-3" placeholder="输入价格信息">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <div class="am-g">
                                    <label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-ipt-pwd-1">发布时间</label>
                                    <input class="am-u-md-10 form-control" type="datetime-local" id="doc-ipt-text-4" name ="doc-ipt-text-4" >
                            ...
                            <div class="am-form-group">
                                <div class="am-g">
                                    ...
                                    <input class="am-u-md-10 form-control" type="datetime-local" id="doc-ipt-text-5" name ="doc-ipt-text-5" >
                                </div>
                            </div>
                            <div class="am-form-group">
                                <div class="am-g">
                                    <label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-ipt-pwd-1">开始时间</label>
                                    <input class="am-u-md-10 form-control" type="datetime-local" id="doc-ipt-text-6" name ="doc-ipt-text-6" >
                                </div>
                            </div>
                            <div>
                                <div class="am-form-group">
                                    <div class="am-form-group">
                                        <div class="am-g">
                                            ...
                                            <input class="am-u-md-10 form-control" type="datetime-local" id="doc-ipt-text-7" name ="doc-ipt-text-7" >
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        <div class="am-g">
                                            <label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-ipt-pwd-1">最大人数</label>
                                            <input class="am-u-md-10 form-control" id="doc-ipt-text-8" name ="doc-ipt-text-8" placeholder="输入最大人数信息" >
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        <div class="am-g">
                                            <label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-ipt-pwd-1">地点</label>
                                            <input class="am-u-md-10 form-control" id="doc-ipt-text-9" name ="doc-ipt-text-9" placeholder="输入地址" >
                                        </div>
                                    </div>
                                </div>
                                <button type="button" onclick="postTask()" class="am-btn am-btn-primary">Submit</button>
                            </div>
                            <!-- Row end -->
